<?php
/*
Plugin Name: indexFTP
Plugin URI: http://indexsystems.net
Description: MiindexFTPP is a smart, fast and lightweight file manager component. It operates from WordPress back-end so you don't have to use any FTP program anymore.
Author: Miwisoft LLC
Version: 1.0.6
Author URI: 
Plugin URI: 
